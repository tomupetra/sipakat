...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-12">
                    <a href="{{ url('admin/berita/tambah') }}" class="btn btn-success">Tambah Berita</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            @foreach ($getRecord as $value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/berita/edit/' . $value->id) }}" class="btn btn-primary btn-sm">Edit</a>
        ...
        <script>
                ...
                fetch(`/admin/berita/detail/${id}`)
                    ...
                    .then(data => {
                        ...
                        detailContent.innerHTML = `
                            ...
                            <p><strong>Isi berita:</strong> ${data.content}</p>
                            ${data.image ? `<p><strong>Gambar:</strong><br><img src="/images/${data.image}" class="img-fluid" alt="Gambar berita"></p>` : ''}
                        `;
            ...
            function showDeleteModal(id) {
                ...
                deleteForm.action = '/admin/berita/delete/' + id;
