...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tambah Renungan</h1>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-12">
                    <form action="{{ url('admin/renungan/tambah') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="ayat_harian" name="ayat_harian" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="bacaan_pagi" class="form-label">Bacaan Pagi</label>
                            <input type="text" class="form-control" id="bacaan_pagi" name="bacaan_pagi" required>
                        </div>
                        <div class="mb-3">
                            <label for="bacaan_malam" class="form-label">Bacaan Malam</label>
                            <input type="text" class="form-control" id="bacaan_malam" name="bacaan_malam" required>
                        </div>
                        <div class="mb-3">
                            <label for="lagu_ende" class="form-label">Lagu/Ende</label>
                            <input type="text" class="form-control" id="lagu_ende" name="lagu_ende" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success">Tambah Renungan</button>
                    </form>
                </div>
            </div>
        </div>
